...
function PlanYear({ setPlan, plan }) {
  return (
    <>
        ...
        >
          <div className="inline-flex items-center gap-5 lg:flex lg:flex-col lg:items-start">
            ...
            <div className="flex flex-col gap-1">
              ...
              <p className="text-sm font-medium text-cool-gray">$90/yr</p>
        ...
        >
          <div className="inline-flex items-center gap-5 lg:flex lg:flex-col lg:items-start">
            ...
            <div className="flex flex-col gap-1">
              ...
              <p className="text-sm font-medium text-cool-gray">$120/yr</p>
              <p className="text-sm font-medium text-marine-blue">
                2 months free
              </p>
            </div>
        ...
        >
          <div className="inline-flex items-center gap-5 lg:flex lg:flex-col lg:items-start">
            ...
            <div className="flex flex-col gap-1">
              ...
              <p className="text-sm font-medium text-cool-gray">$150/yr</p>
              <p className="text-sm font-medium text-marine-blue">
                2 months free
              </p>
            </div>
